/* esm.sh - esbuild bundle(react-router@6.2.2) deno development */
// esm-build-befa2f3dbfe2f3439db52cb99f3031851637847c-b3deddd3/node_modules/react-router/index.js
import { createContext, useRef, useState, useLayoutEffect, createElement, useContext, useEffect, useMemo, useCallback, Children, isValidElement, Fragment } from "/v70/react@17.0.2/deno/react.development.js";
import { createMemoryHistory, Action, parsePath } from "/v70/history@5.3.0/deno/history.development.js";
import { Action as Action2, createPath, parsePath as parsePath2 } from "/v70/history@5.3.0/deno/history.development.js";
