import * as URI from "https://cdn.esm.sh/v68/uri-js@4.4.1/dist/es5/uri.all.d.ts";
import type { CodeGen, Code, Name, ScopeValueSets, ValueScopeName } from "../compile/codegen/index.d.ts";
import type { SchemaEnv, SchemaCxt, SchemaObjCxt } from "../compile/index.d.ts";
import type { JSONType } from "../compile/rules.d.ts";
import type { KeywordCxt } from "../compile/validate/index.d.ts";
import type Ajv from "../core.d.ts";
