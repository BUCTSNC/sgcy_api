import type { AnySchema, AnySchemaObject, AnyValidateFunction, EvaluatedProperties, EvaluatedItems } from "../types/index.d.ts";
import type Ajv from "../core.d.ts";
import type { InstanceOptions } from "../core.d.ts";
import { CodeGen, Name, Code, ValueScopeName } from "./codegen/index.d.ts";
import { LocalRefs } from "./resolve.d.ts";
